...
C  Half petal
!         Lambda1St1=1.0
!         Lambda2St1=1.0/16.0*Sqrt((1.0+STATEV(5))**2)*
!      &  (8.0-SQMMOD-(4*(-4.0+SQMMOD)*(-7+2*STATEV(5)))
!      &  /Sqrt((1.0+STATEV(5))**2*(53.0-28*STATEV(5)
!      &  +4.0*STATEV(5)**2)))
!         Lambda3St1=Sqrt(53.0/4.0+(-7.0+STATEV(5))*STATEV(5))
!      &  -(2.0*(-4.0+SQMMOD)*(1.0+STATEV(5)))/(Sqrt(53.0/4.0
!      &  +(-7.0+STATEV(5))*STATEV(5))*Sqrt((1.0+STATEV(5))**2
!      &  *(53.0+4.0*(-7.0+STATEV(5))*STATEV(5))))
C
        Lambda1St1=1.0
        Lambda2St1=1.0/8.0*Sqrt((1.0+STATEV(5))**2)*
     &  (8.0-SQMMOD-(4*(-4.0+SQMMOD)*(-7+2*STATEV(5)))
     &  /Sqrt((1.0+STATEV(5))**2*(53.0-28*STATEV(5)
     &  +4.0*STATEV(5)**2)))
        Lambda3St1=Sqrt(53.0/4.0+(-7.0+STATEV(5))*STATEV(5))
