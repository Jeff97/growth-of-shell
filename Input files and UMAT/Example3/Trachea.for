...
C
        Lambda1St1=1.0
        Lambda2St1=1.0/80.0*Sqrt((20.0+Sin(2.0*Pi*STATEV(5)))**2)*
     &  (4.0+(-4.0+SQMMOD)*(-1+(100.0*Sqrt(2.0))/
     &  Sqrt((50.0+Pi**2+Pi**2*Cos(4.0*Pi*STATEV(5)))
     &  *(20.0+Sin(2.0*Pi*STATEV(5)))**2)))
        Lambda3St1=(Sqrt(2.0)*(50.0+Pi**2+Pi**2*
     &  Cos(4.0*Pi*STATEV(5)))+(100.0*Pi**2*(-4.0+SQMMOD)*
     &  Sin(2.0*Pi*STATEV(5))*(20.0+Sin(2*Pi*STATEV(5))))/
     &  Sqrt((50.0+Pi**2+Pi**2*Cos(4.0*Pi*STATEV(5)))*
     &  (20.0+Sin(2*Pi*STATEV(5)))**2))/(5.0*Sqrt(50.0
     &  +Pi**2+Pi**2*Cos(4.0*Pi*STATEV(5))))
C
        STATEV(6)=Lambda1St1
        STATEV(7)=Lambda2St1
        STATEV(8)=Lambda3St1
